...
//                }
    ...
    public static function sendTestNotification($form_id, $notification) {
        ...
        $_subj = self::render_with_post(stripslashes($_subj), $post_id, false);
        ...
        $_bod = self::render_with_post($_bod, $post_id);
...
//            }
	 ...
	 * @return string
	 */
	public static function render_with_post( $content, $_post_id, $rich = true ) {
		if ( ! $_post_id ) {
