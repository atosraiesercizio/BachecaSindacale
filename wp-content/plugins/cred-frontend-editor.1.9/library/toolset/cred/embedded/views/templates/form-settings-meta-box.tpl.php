                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo CRED_Helper::getRichEditor('credformactionmessage', '_cred[form][action_message]', $settings['action_message'], array('wpautop' => true, 'teeny' => true, 'editor_height' => 100, 'editor_class' => 'wpcf-wysiwyg', 'quicktags'=> array( 'buttons' => '' ) )); ?>
