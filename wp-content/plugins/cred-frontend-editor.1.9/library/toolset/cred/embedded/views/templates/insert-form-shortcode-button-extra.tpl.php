...
<span class="cred-media-button cred-form-shortcode-button2">
    ...
    <?php } else { ?>
        <a href='javascript:;' class='button cred-icon-button cred-form-shortcode-button-button2' title='<?php echo esc_attr( __( 'Insert Forms', 'wp-cred' ) ); ?>'><i class="icon-cred-logo ont-icon-18"></i><?php echo __( 'CRED Forms', 'wp-cred' ); ?></a>
    <?php } ?>
	<?php
	$edit_form_help_link = $help['cred_inserting_edit_links']['link'];
	$edit_form_help_text = $help['cred_inserting_edit_links']['text'];
	$help_link_query_args = array(
		'utm_source' => 'credplugin',
		'utm_campaign' => 'cred',
		'utm_medium' => 'form-insert-dialog',
		'utm_term' => $edit_form_help_text
	);
	$edit_form_help_link = add_query_arg( $help_link_query_args, $edit_form_help_link );
	?>
        ...
        <div class="cred-popup-inner cred-form-shortcodes-box-inner2">
            <div class='cred-form-shortcode-types-select-container2'>
                <table class='cred-table cred-table-choose-form' cellpadding=0 cellspacing=0>
                    ...
                    <tr>
                        <td colspan=2>
                            <label class='cred-label'><input type='radio' class='cred-shortcode-container-radio cred-radio-10' data-target='cred-post-creation-container2' name='cred-shortcode-container-<?php echo $id; ?>' value='1' /><span class='cred-radio-replace'></span>
                                <span ><?php _e( 'New Post Form', 'wp-cred' ); ?></span></label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan=2>
                            <label class='cred-label'><input type='radio' class='cred-shortcode-container-radio cred-radio-10' data-target='cred-post-edit-container2' name='cred-shortcode-container-<?php echo $id; ?>' value='2' /><span class='cred-radio-replace'></span>
                                <span ><?php _e( 'Edit Post Form', 'wp-cred' ); ?></span> <a href="<?php echo $edit_form_help_link; ?>" class="cred-box-doc-link" target="_blank"><?php echo $edit_form_help_text; ?></a>
							</label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan=2>
                            <label class='cred-label'><input type='radio' class='cred-shortcode-container-radio cred-radio-10' data-target='cred-post-delete-link-container2' name='cred-shortcode-container-<?php echo $id; ?>' value='3' /><span class='cred-radio-replace'></span>
                                <span ><?php _e( 'Delete Post Link', 'wp-cred' ); ?></span></label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan=2>
                            <label class='cred-label'><input type='radio' class='cred-shortcode-container-radio cred-radio-10' data-target='cred-post-child-link-container2' name='cred-shortcode-container-<?php echo $id; ?>' value='4' /><span class='cred-radio-replace'></span>
                    ...
                    <tr>
                        <td colspan=2>
                            <label class='cred-label'><input type='radio' class='cred-shortcode-container-radio cred-radio-10' data-target='cred-user-creation-container2' name='cred-shortcode-container-<?php echo $id; ?>' id='cred-user-creation-container' value='5' />
                    ...
                    <tr>
                        <td colspan=2>
                            <label class='cred-label'><input type='radio' class='cred-shortcode-container-radio cred-radio-10' data-target='cred-user-edit-container2' name='cred-shortcode-container-<?php echo $id; ?>' id='cred-user-edit-container' value='6' />
                                <span><?php _e( 'Edit User Form', 'wp-cred' ); ?></span> <a href="<?php echo $edit_form_help_link; ?>" class="cred-box-doc-link" target="_blank"><?php echo $edit_form_help_text; ?></a></label>
                        </td>
                    </tr>
                                ...
                                <optgroup label="<?php echo esc_attr( __( 'Select post form', 'wp-cred' ) ); ?>">
                                    ...
                                    foreach ( $forms as $form ) {
                                        if ( isset( $form->meta->form['type'] ) && $form->meta->form['type'] == 'new' ) {
                                            echo "<option rel='{$form->post_name}' value='{$form->ID}'>{$form->post_title}</option>";
                                        }
                                    }
                                    ?>
                                </optgroup>
                                ...
                                <optgroup label="<?php echo esc_attr( __( 'Select post form', 'wp-cred' ) ); ?>">
                                    ...
                                    foreach ( $forms as $form ) {
                                        if ( isset( $form->meta->form['type'] ) && $form->meta->form['type'] == 'edit' ) {
                                            echo "<option class='" . esc_attr( "_cred_cred_{$form->meta->form['type']}" ) . "' rel='" . esc_attr( $form->post_name ) . "' value='" . esc_attr( $form->ID ) . "'>{$form->post_title}</option>";
                                        }
                                    }
                                    ?>
                                </optgroup>
