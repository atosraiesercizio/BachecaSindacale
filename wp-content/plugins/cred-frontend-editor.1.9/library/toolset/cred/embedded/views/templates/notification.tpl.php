...
<div id="cred_notification_settings_panel-<?php echo $ii; ?>" class='cred_notification_settings_panel cred_validation_section' style="display:none;">
    ...
    <fieldset class="cred-fieldset">
        ...
        <p class="cred-label-holder">
            ...
            <input data-cred-bind="{
                   ...
                   }" type="text" class='cred_mail_subject' id="credmailsubject<?php echo $ii ?>" style="position:relative;width:95%;" name="_cred[notification][notifications][<?php echo $ii; ?>][mail][subject]" value="<?php echo $notification['mail']['subject']; ?>" />
        </p>
    </fieldset>
    ...
    <fieldset class="cred-fieldset">
        ...
        <div id="cred_mail_body_placeholders-<?php echo $ii; ?>" class="wpcf-wysiwyg">
            ...
            <?php
            echo CRED_Helper::getRichEditor( "credmailbody{$ii}", "_cred[notification][notifications][{$ii}][mail][body]", $notification['mail']['body'], array(
	            'wpautop'       => false,
	            'teeny'         => true,
	            'editor_height' => 200,
	            'editor_class'  => 'wpcf-wysiwyg', // add class for Types and Views use
	            'quicktags'     => array( 'buttons' => 'b' )
            ), array(
	            'custom_media_buttons' => true
            ) );

            echo CRED_Loader::tpl('notification-body-codes', array(
