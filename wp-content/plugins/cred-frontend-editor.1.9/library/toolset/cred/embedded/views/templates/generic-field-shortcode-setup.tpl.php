    ...
    <body id='cred_generic_fields' class="wp-core-ui">
        ...
        <div style="display:none">
            <div id="shortcode_tip">
                ...
                <p><?php _e('When options for a generic field need to be generated dynamically, a shortcode can be used to generate the field options on the fly. Any shortcode which will generate a valid JSON format of options can be used.', 'wp-cred'); ?></p>
            </div>
        </div>
    </body>
</html>
