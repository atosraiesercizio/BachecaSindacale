...
<span id="cred-shortcode-button" class="cred-media-button">
    <a href='javascript:;' id="cred-shortcode-button-button" class='button cred-button' title='<?php echo esc_attr(__('Add User Fields','wp-cred')); ?>'><i class="icon-cred-logo ont-icon-18"></i><?php _e('Add User Fields','wp-cred'); ?></a>
    <div id="cred-shortcodes-box" class="cred-popup-box">
        <div class='cred-popup-heading'>
        <h3><?php _e('User Fields (click to insert)','wp-cred'); ?></h3>
        ...
        <a class='cred-help-link' href='<?php echo $help['fields_settings_users']['link']; ?>' target='<?php echo $help_target; ?>' title="<?php echo esc_attr($help['fields_settings_users']['text']); ?>">
			<i class="icon-question-sign"></i>
			<span><?php echo $help['fields_settings_users']['text']; ?></span>
		</a>
    </div>
</span>