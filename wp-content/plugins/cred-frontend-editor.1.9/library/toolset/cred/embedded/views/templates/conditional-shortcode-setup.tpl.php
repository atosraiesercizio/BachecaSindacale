...
<head>
	...
	?>
    <!-- templates -->
    <script id='conditional-term-template' type='text/html-template'>
        <tr class='expression-term-single row2'>
            ...
            <td class='cell2'>
                <a class='remove-option' href='javascript:;'
                   title='<?php echo esc_attr( __( 'Remove term', 'wp-cred' ) ); ?>'></a>
            </td>
        </tr>
    </script>
    <!-- templates end -->
    ...
    <script type='text/javascript'>
        ...
        (function (window, $, cred, undefined) {
            ...
            $(function () {
                ...
                tmpl = $('#conditional-term-template').html();
...
<div id='container'>
    <form>
        ...
        <div id='_expression_container'>
            ...
            <textarea id='_conditional_expression' style='position:relative;width:90%;overflow-y:auto;'
                      rows='5'></textarea>
        </div>
        ...
        <div id='mygui'>
            ...
            <p class="add-option-wrapper">
                <a href='javascript:;' class='add-option button'
                   title='<?php echo esc_attr( __( 'Add term', 'wp-cred' ) ); ?>'><?php _e( 'Add term', 'wp-cred' ); ?></a>
            </p>
        </div>

        <p class="cred-buttons-holder">
            <a href='javascript:;' id='cancel' class='button'
               title='<?php echo esc_attr( __( 'Cancel', 'wp-cred' ) ); ?>'><?php _e( 'Cancel', 'wp-cred' ); ?></a>
            <input id='submit' type='button' class='button button-primary'
                   value='<?php echo esc_attr( __( 'Insert', 'wp-cred' ) ); ?>'/>
        </p>
    </form>
</div>
<a class='cred-help-link-white' style='position:absolute;top:10px;right:10px'
   href='<?php echo $help['conditionals']['link']; ?>' target='<?php echo $help_target; ?>'
   title="<?php echo esc_attr( $help['conditionals']['text'] ); ?>">
