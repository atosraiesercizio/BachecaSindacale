    ...
    public function __construct( $nameForm = 'default' )
    {
        ...
        if ( Toolset_Utils::is_real_admin() ) {
            ...
            if ( is_array($cred_cred_settings) ) {
                if ( array_key_exists('dont_load_cred_css', $cred_cred_settings) && $cred_cred_settings[ 'dont_load_cred_css' ] === "0" ) {
                    $load_cred_legacy_css = true;
                }
                if ( array_key_exists('dont_load_bootstrap_cred_css', $cred_cred_settings) && $cred_cred_settings[ 'dont_load_bootstrap_cred_css' ] === "1" ) {
