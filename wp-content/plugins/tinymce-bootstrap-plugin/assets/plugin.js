...
(function() {
    tinymce.create('tinymce.plugins.tinymce_bootstrap_plugin', {
        ...
        if(typeof(editor.settings.bootstrapConfig.bootstrapMediaPath) == 'undefined') {
            DefaultImagesPath = url + '/';
            editor.settings.bootstrapConfig.bootstrapMediaPath = {'imagesPath': DefaultImagesPath};
        }
        imagesPath = editor.settings.bootstrapConfig.bootstrapMediaPath;
        ...
        getInfo : function() {
            return {
                longname : 'Tinymce Bootstrap Plugin',
   ...
   tinymce.PluginManager.add('tinymce_bootstrap_plugin', tinymce.plugins.tinymce_bootstrap_plugin);
})();
